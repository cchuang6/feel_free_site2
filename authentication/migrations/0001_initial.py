    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('businessname', models.CharField(default=b'buname', max_length=35)),
                ('spaceId', models.CharField(max_length=10, unique=True, null=True, blank=True)),
                ('zipcode', localflavor.us.models.USZipCodeField(default=b'00000', max_length=10)),
                ...
                ('phone', localflavor.us.models.PhoneNumberField(default=b'000-000-0000', max_length=20)),
                ('tierlist', models.CharField(blank=True, max_length=1, null=True, choices=[(b'1', b'Silver'), (b'2', b'Gold'), (b'3', b'Platinum')])),
